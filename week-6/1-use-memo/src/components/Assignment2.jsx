...
// The goal is to use useMemo to optimize the filtering process, ensuring the list is only 
//re-calculated when necessary (e.g., when the filter criteria changes).
// You will learn something new here, specifically how you have to pass more than one 
